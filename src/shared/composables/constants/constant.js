...
export const subcategories = [
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы", "Защита"],
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы"],
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы"],
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы"],
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы"],
  ["Телефоны", "Смартфоны", "Аксессуары", "Смарт-часы", "Ремешки", "Чехлы"],
...
export const footerLinks = [
  {
    ...
    links: [
      { to: "#", text: "Как сделать заказ" },
      { to: "#", text: "Оплата" },
      { to: "#", text: "Покупать как компания" },
      { to: "#", text: "Безопасность" },
      { to: "#", text: "Обработка данных" },
      { to: "#", text: "Возврат товаров" },
      { to: "#", text: "Адреса ПВЗ" },
    ],
  },

  {
    title: "Партнерам",
    links: [
      { to: "#", text: "Открытие ПВЗ" },
      { to: "#", text: "Логистика" },
      { to: "gdfgf", text: "Инвестирование" },
      ,
      { to: "#", text: "События" },
    ],
  },

  {
    ...
    links: [
      { to: "#", text: "Руководство" },
      ,
      { to: "#", text: "Наша команда" },
      ,
      { to: "#", text: "История" },
      ,
      { to: "#", text: "Сайт компании" },
...

  {
    title: "Работа у нас",
    links: [
      { to: "#", text: "Наши вакансии" },
      ,
      { to: "#", text: "Давайте знакомиться" },
      ,
      { to: "#", text: "Почему мы" },
    ],
  },
