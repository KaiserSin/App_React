    ...
    <div className="gpt-summary">
      <div className="gpt-summary__header">
        <div className="gpt-summary__header-left">
          <img
            src={artificialEmblem}
            alt="SwiftMart Icon"
            className="gpt-summary__icon"
          />
      ...
      <p className="gpt-summary__description">
        Компьютерная мышь в корзине, на первый взгляд, выглядит неплохо, но
        имеет ряд недостатков, например некачественный кабель, что делает её
        недолговечной. Предлагаю рассмотреть этот вариант:
        <a href="#" className="gpt-summary__link">
        ...
        <div className="gpt-summary__footer-left">
          <button className="text-button">
            <img
              ...
              className="gpt-summary__icon"
            />
            <span className="gpt-summary__footer-text">
