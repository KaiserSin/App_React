  ...
  return (
    <div className="delivery-info">
      <div className="delivery-info__header">
        ...
        <hr className="delivery-info__divider" />
      </div>
        
      <div className="delivery-info__customs-warning">
        <img src={plane} alt="Plane Icon" className="delivery-info__plane-icon" />
    ...
    <div className="delivery-info__options">
      <div className="delivery-info__option">
        <span>Доставим <span className='bold-text'>29 августа</span> ·<span className='translucent-text'> курьером </span>· <span className='bold-text'>0Р</span></span>
      </div>
      <div className="delivery-info__option">
        <span><span className='bold-text'>29 августа</span> · <span className='translucent-text'>в пункт выдачи</span> · 0Р</span>
      </div>
      <hr className="delivery-info__divider" />
      <div className="delivery-info__option">
        <span><span className='bold-text'>Послезавтра</span> · <span className='translucent-text'>курьером supreme</span></span>
        
          <img src={subscription} alt="Subscription Icon" className="delivery-info__subscribe-icon" />
        
      </div>
      <div className="delivery-info__option">
        <span><span className='bold-text'>28 августа</span> · <span className='translucent-text'>SwiftMart Speedy</span> · <span className='bold-text'>350Р</span></span>
      </div>
      <hr className="delivery-info__divider" />
      <div className="delivery-info__note">
        <img src={exclamation} alt="Info Icon" className="delivery-info__note-icon" />
        <span  className='delivery-date'>Выбрать даты, время и способ доставки можно при оформлении заказа</span>
      </div>
    </div>

    <div className="delivery-info__promo">
      <input type="text" className="delivery-info__promo-input" placeholder="Промокод" />
      <button className="delivery-info__promo-button">
        Применить
      </button>
    </div>
    ...
    <div className="delivery-info__payment">
      <div>
            <img src={dolyami} alt="Payment Icon" className="delivery-info__payment-icon" />
            <span className="delivery-info__payment-text">4 платежа по 1 000 ₽</span>
      </div>
      <img src={arrow} alt="Arrow Icon" className="delivery-info__arrow-icon" />
    </div>
    ...
    <div className="delivery-info__checkout">
      ...
      <button className="delivery-info__trashcan-button">
        <img src={trashbin} alt="Trashcan Icon" className="delivery-info__trashcan-icon" />
      </button>
    </div>
    ...
    <div className="delivery-info__message">
      <img src={exclamation} alt="Exclamation Icon" className="delivery-info__message-icon" />
      <p className="delivery-info__message-text">
        Вы можете настроить расписание для автоматических покупок товаров. Для этого положите необходимые товары в корзину, привяжите карту или пополните баланс личного кабинета, а затем нажмите кнопку выше.
      </p>
    </div>
</div>
  );
