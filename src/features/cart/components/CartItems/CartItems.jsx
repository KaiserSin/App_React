...

{
  /* <div
key={item.id}
className={`cart-items__product ${
  item.status.available ? "cart-items__product--out-of-stock" : ""
}`}
>
  ...
  <div className="cart-items__actions">
    <div>
      ...
      <img
        ...
        className="cart-items__action-icon"
      />
      <button className="cart-items__order-button">
        Заказать
      </button>
    </div>
    ...
    <div className="paragraph-status">
      <p
        className={`cart-items__status ${
          item.status === "Осталось меньше"
            ? "cart-items__status--red"
            : ""
        }`}
      >
        {item.status}
...
<div className="fourth-column">
  <div className="cart-items__pricing">
    <p
      className={`cart-items__price ${
        item.sellout
          ? "cart-items__price--red"
          : "cart-items__price--green"
      }`}
    >
      {item.price}
    </p>
